    ...
    */
    ...
    public function register(Request $request)
    {
        ...
        return $request->wantsJson()
                    ? new Response('', 201)
                    : redirect('/login')->with('success' ,'Votre compte a bien été crée, vous devez le confirmer avec l\'email que vous allez recevoir.');
    }
    ...
    {
        //any information passing through this form is necessarily that of a student    
        $user_role = "student";
