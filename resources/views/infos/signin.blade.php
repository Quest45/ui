            ...
            <div class="signin-form">
              ...
              <div class="form-group">
                <label class="d-flex justify-content-between">
                  ...
                  <a href="/forgot" class="tx-13">Mot de passe oublié ?</a>
                </label>
                <input name="password" type="password" class="form-control" placeholder="votre mot de passe" value="">
              </div>

              <div class="form-group d-flex mg-b-0">
                <button type="submit" class="btn btn-brand-01 btn-uppercase flex-fill">CONNEXION</button>
                <a href="/signup" class="btn btn-white btn-uppercase flex-fill mg-l-10">INSCRIPTION</a>
              </div>
            </div>
          </form>
